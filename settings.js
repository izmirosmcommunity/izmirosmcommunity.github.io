...
var challengeDate = 'Dec 15rd - Dec 16st, 2017'
var docTitle = 'Complete the Map: Izmir - Mapillary'; //text next to favicon on browser window

var challengeLng = 38.4116,27; //center of the map 
var challengeLat = 27.1412; //center of the map
